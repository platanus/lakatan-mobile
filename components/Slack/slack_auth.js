...
const SlackAuth = () => {
  ...
  const link = `https://slack.com/oauth/v2/authorize?scope=channels:read,groups:read,team:read,usergroups:read,users.profile:read,users:read,users:read.email&client_id=${client}`;
